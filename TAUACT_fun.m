function TAUACT_fun(XNCG,XKA,XKDC,XKR,...
    WI,TA,WZ,XK1,XK3,WACT,ZETAACT,W0,Z0,XK0,WAF,ZAF,TF,handles,WCR)
m=0;
TAUACT_vector=linspace(0.004,0.012,3);

for TAUACT=TAUACT_vector
...
datastr1=strcat('TAU act = ',num2str(TAUACT_vector(1)),'[s]');

datastr2=strcat('TAU act = ',num2str(TAUACT_vector(2)),'[s]');

datastr3=strcat('TAU act = ',num2str(TAUACT_vector(3)),'[s]');
...
save resultadosTAU.mat W_0dB W_phase180 GAIN_180phase GAIN_WCR Gmar_1 Gmar_2 G_error...
